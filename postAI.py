...
print("FB_PASSWORD:", FB_PASSWORD)

if not FB_EMAIL or not FB_PASSWORD:
    print("Facebook 帳號或密碼未設置，請檢查 .env 檔案。")
    exit(1)
...
with sync_playwright() as p:
    browser = p.chromium.launch(
        ...
        executable_path=EDGE_PATH  # 指定 Edge 可執行檔路徑
    )
    page = browser.new_page()

    print("啟動 Edge 瀏覽器，開始登入 Facebook...")
    ...
    page.keyboard.type("AI機器人測試，這是一則由 Playwright 自動發佈的 Facebook 貼文！", delay=100)
    print("已模擬真人輸入")
